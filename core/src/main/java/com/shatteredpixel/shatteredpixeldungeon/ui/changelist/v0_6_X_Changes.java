...
public class v0_6_X_Changes {
	...
	public static void add_v0_6_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.WARRIOR, 0, 90, 12, 15), "Berserker",
		...
		changes.addButton( new ChangeButton(com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.MAGE, 0, 90, 12, 15), "Warlock",
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.HUNTRESS, 0, 15, 12, 15), "Huntress",
	...
	public static void add_v0_6_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.ROGUE, 0, 15, 12, 15), "Rogue Rework!",
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.ROGUE, 0, 90, 12, 15), "Rogue Subclasses Rework!",
