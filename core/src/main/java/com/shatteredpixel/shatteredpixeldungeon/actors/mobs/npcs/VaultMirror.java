		...
		Random.pushGenerator(Random.Long());
			switch (cls) {
				...
				case CLERIC:
					...
					break;
				case NECROMANCER:
					com.shatteredpixel.shatteredpixeldungeon.items.Phylactery vessel = new com.shatteredpixel.shatteredpixeldungeon.items.Phylactery();
					vessel.level(8);
					vessel.gainCharge(vessel.cap());
					reward = vessel;
					break;
				case ENCHANTER:
					...
					brush.gainCharge(brush.cap());
					reward = brush;
					break;
				case PSYCHIC:
					com.shatteredpixel.shatteredpixeldungeon.items.FocusCrystal focus = new com.shatteredpixel.shatteredpixeldungeon.items.FocusCrystal();
					focus.gainCharge(focus.cap());
					reward = focus;
					break;
			}
		Random.popGenerator();
					...
					if (reward != null) {
						...
						switch (((Hero) c).heroClass){
							...
							case CLERIC:
								...
								break;
							case NECROMANCER:
								sceneText += Messages.get(VaultMirror.class, "scene_necromancer");
								break;
							case ENCHANTER:
								sceneText += Messages.get(VaultMirror.class, "scene_enchanter");
								break;
							case PSYCHIC:
								sceneText += Messages.get(VaultMirror.class, "scene_psychic");
								break;
						}
