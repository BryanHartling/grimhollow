...
public class v0_7_X_Changes {
	...
	public static void add_v0_7_4_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.MAGE, 0, 90, 12, 15), "Subclass Adjustments",
	...
	public static void add_v0_7_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.WARRIOR, 0, 90, 12, 15), "Berserker & Gladiator",
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.WARRIOR, 0, 15, 12, 15), "Warrior Nerfs",
	...
	public static void add_v0_7_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.HUNTRESS, 0, 15, 12, 15), "Huntress Reworked!",
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.HUNTRESS, 0, 90, 12, 15), "Huntress Subclasses Reworked!",
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.ROGUE, 0, 15, 12, 15), "Hero Buffs",
