...
public enum Talent {
	...
	//Necromancer talents
    RECALL(272), WRENCH(273), LINGERING_SIGHT(274), TRAP_SENSE(275), GUIDED_THROW(276), DEEP_FOCUS(277), PRECOGNITION(278), KINETIC_RESERVE(279), FRACTURE_POINT(280), FOCUSED_MIND(281, 3), FAR_REACH(282, 3), SHARED_WILL(283, 3), HARVEST_THOUGHT(284, 3), HEAVY_HAND(285, 3), TREASURE_SENSE(286, 3), WIDER_STORM(287, 3), DREAD(288, 3), BACKLASH(289, 3), LONG_MELD(290, 3), TOTAL_SIGHT(291, 3), KINETIC_SURGE(292, 3), HELD_FIRM(293, 3), REPULSE(294, 3), PERMEABLE(295, 3),
