...
public enum Talent {
	...
	//Necromancer talents
    RECALL(272), WRENCH(273), LINGERING_SIGHT(274), TRAP_SENSE(275), GUIDED_THROW(276), DEEP_FOCUS(277), PRECOGNITION(278), KINETIC_RESERVE(279), FRACTURE_POINT(280), FOCUSED_MIND(281, 3), FAR_REACH(282, 3), SHARED_WILL(283, 3), HARVEST_THOUGHT(284, 3), HEAVY_HAND(285, 3), TREASURE_SENSE(286, 3), WIDER_STORM(287, 4), DREAD(288, 4), BACKLASH(289, 4), LONG_MELD(290, 4), TOTAL_SIGHT(291, 4), KINETIC_SURGE(292, 4), HELD_FIRM(293, 4), REPULSE(294, 4), PERMEABLE(295, 4),
    KEEN_STUDY(248), STEADY_HAND(249), SHARPENED_SIGILS(250), FIELD_REPAIR(251), DUAL_INSCRIPTION(252), RESONANCE(253), WARDING_SIGILS(254), ATTUNEMENT(255), OVERLOAD(256), EFFICIENT_SIGILS(257, 3), DEEP_KNOWLEDGE(258, 3), MASTER_CRAFT(259, 3), LASTING_WORK(260, 3), WIDE_FIELD(261, 3), COUNTERWEIGHT(262, 3), SUSTAINED(263, 4), AMPLIFIED(264, 4), FEEDBACK(265, 4), WIDE_SANCTUARY(266, 4), CONSECRATED(267, 4), MOBILE(268, 4), CASCADE(269, 4), SALVAGE(270, 4), RECLAMATION(271, 4),
    GRAVE_HARVEST(224), BONE_MEAL(225), CORPSE_SENSE(226), NECROTIC_TOUCH(227), STURDY_BONES(228), DARK_PACT(229), SECOND_GRAVE(230), WARD_OF_BONE(231), NECROTIC_SIPHON(232), DEATHSPEAKERS_COMMAND(233, 3), GRAVE_WISDOM(234, 3), BONE_LEGION(235, 1), GRAVE_SPEECH(236, 3), LINGERING_HEX(237, 3), CURSED_GROUND(238, 3), WIDER_BLAST(239, 4), ROT(240, 4), SOUL_REFUND(241, 4), BLESSED_PACT(242, 4), BONE_SHELL(243, 4), RECLAIMED(244, 4), LASTING_CAGE(245, 4), JAGGED(246, 4), NECROMANCERS_KEY(247, 4),
	...
	public static void initClassTalents( HeroClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, LinkedHashMap<Talent, Talent> replacements ){
		...
		switch (cls){
            ...
            case PSYCHIC: Collections.addAll(tierTalents, RECALL, WRENCH, LINGERING_SIGHT, TRAP_SENSE); break;
			case WARRIOR: default:
		...
		switch (cls){
            ...
            case PSYCHIC: Collections.addAll(tierTalents, GUIDED_THROW, DEEP_FOCUS, PRECOGNITION, KINETIC_RESERVE, FRACTURE_POINT); break;
			case WARRIOR: default:
		...
		switch (cls){
            ...
            case PSYCHIC: Collections.addAll(tierTalents, FOCUSED_MIND, FAR_REACH); break;
			case WARRIOR: default:
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		//tier 3
		switch (cls){
			case PUPPETEER: Collections.addAll(tierTalents, SHARED_WILL, HARVEST_THOUGHT); break;
            case SEER: Collections.addAll(tierTalents, HEAVY_HAND, TREASURE_SENSE); break;
