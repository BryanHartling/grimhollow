...
public class v0_9_X_Changes {
	...
	public static void add_v0_9_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.WARRIOR, 0, 90, 12, 15), HeroSubClass.GLADIATOR.title(),
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.ROGUE, 0, 90, 12, 15), HeroSubClass.FREERUNNER.title(),
	...
	public static void add_v0_9_1_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.HUNTRESS, 0, 15, 12, 15), "Huntress and Rogue Adjustments",
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.MAGE, 0, 90, 12, 15), HeroSubClass.BATTLEMAGE.title(),
	...
	public static void add_v0_9_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.WARRIOR, 0, 15, 12, 15), "Hero balance adjustments",
