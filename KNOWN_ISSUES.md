...
- Stages 6a-6b ship animated liquids and the calibrated Prison environment; Caves/City/Halls art, character redesign, items/title, enhanced effects and section 9 content remain pending in stages 6c-8.
- Tests 4 and 17 remain incomplete: 95 existing sheets lack pipeline sources and full character/item style and referenced-frame coverage are unfinished; the implemented inventory is 70 specifications.
...
- Tests 16, 18, 19, 30 and 42 are NOT RUN in full: complete sprite-index coverage, five-region luminance/room gates, floor-15 timing and regional mob-histogram checks remain pending; Sewers and Prison have complete room measurements; the Halls screenshot currently certifies liquid appearance only.
...
- Test 29 retains the 104 liquid/ripple and prior 288-frame results; the 24 Prison frames/masks pass with maximum pHash distance 0, approved Sewers caches stay locked, and reviewed caches are restored after verification.
