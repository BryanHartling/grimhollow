...
public class v1_X_Changes {
	...
	public static void add_v1_4_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.WARRIOR, 0, 90, 12, 15), HeroSubClass.BERSERKER.title(),
	...
	public static void add_v1_1_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.ROGUE, 0, 90, 12, 15), HeroSubClass.ASSASSIN.title(),
