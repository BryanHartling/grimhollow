...
public class Terrain {
    ...
    // v4 uses 39 for custom scenery with water passthrough; keep it distinct.
    public static final int BONE_WALL=41, FORCE_WALL=40;
	...
	static {
        ...
        flags[BONE_WALL]=LOS_BLOCKING|SOLID;flags[FORCE_WALL]=SOLID;
