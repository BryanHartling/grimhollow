...
public class ItemSpriteSheet {
	...
	public static final int CURSE_INFUSE    = 421;
	public static final int MAGIC_INFUSE    = 422;
	public static final int ALCHEMIZE       = 423;
	public static final int RECYCLE         = 424;
	public static final int RECLAIM_TRAP    = 426;
	public static final int RETURN_BEACON   = 427;
	public static final int SUMMON_ELE      = 428;
	public static final int SUMMON_ELE_FIRE = 522;
	public static final int SUMMON_ELE_FROST= 523;
	public static final int SUMMON_ELE_SHOCK= 524;
	public static final int SUMMON_ELE_CHAOS= 525;
