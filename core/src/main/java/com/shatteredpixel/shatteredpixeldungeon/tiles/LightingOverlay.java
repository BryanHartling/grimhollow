    ...
    private void rebuild() {
        ...
        for (Blob blob : Dungeon.level.blobs.values()) {
            ...
            for (int cell=0; cell<blob.cur.length; cell++) {
                ...
                if (blob instanceof com.shatteredpixel.shatteredpixeldungeon.actors.blobs.Soulfire || blob instanceof com.shatteredpixel.shatteredpixeldungeon.levels.rooms.special.MagicalFireRoom.EternalFire)
