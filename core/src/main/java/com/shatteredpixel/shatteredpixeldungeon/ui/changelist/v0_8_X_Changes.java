...
public class v0_8_X_Changes {
	...
	public static void add_v0_8_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton( com.shatteredpixel.shatteredpixeldungeon.GameGeometry.heroImage(Assets.Sprites.ROGUE, 0, 90, 12, 15), "Assassin and Sniper",
